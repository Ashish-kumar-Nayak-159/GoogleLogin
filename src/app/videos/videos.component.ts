...
export class VideosComponent {
  ...
  videos: any = [
    ...
    { name: 'For Bigger Blazes', url: 'http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4' },
    { name: 'For Bigger Escape', url: 'http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerEscapes.mp4' },
    { name: 'For Bigger Fun', url: 'http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerFun.mp4' }
  ];
  ...
  playVideo() {
    ...
    video.src = this.videos[this.currentVideoIndex].url;
    video.play();
    video.onended = () => {
